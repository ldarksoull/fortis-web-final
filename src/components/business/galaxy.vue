<template>
    <div class="wrapper">
        <div class="store">
            <div class="main">
                <div class="header">
                    <div class="store-logo galaxy-logo"><img src="/img/stores/galaxy.png" alt="" /></div>
                </div>
                <div class="body">
                    <div class="list">
        ...
        <div class="escape">
            <img src="/img/stores/escape-tips.png" alt="" @click="exit()"/>
        </div>
    </div>
</template>
<script>
...
<style scoped>html, body, div, span, applet, object, iframe,
...
.wrapper {
    ...
    .main{
        background-color: rgba(38, 45, 51, 0.95);
    }
    .header{
        width: 100%;
        height: 21%;
    ...
    .item{
        ...
        height: 5.94vw;
        border-radius: 0.52vw;
        background: linear-gradient(9.33deg, rgba(154, 154, 154, 0.0001) 7.33%, rgba(154, 154, 154, 0.22) 93.25%), #08111A;

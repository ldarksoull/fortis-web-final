<template>
    <div class="wrapper">
        <div class="store">
            <div class="main">
                <div class="header">
                    <div class="store-logo bahamamamas-logo"><img src="/img/stores/bahama-mamas.png" alt="" /></div>
                </div>
                <div class="body">
                    <div class="list">
...
.wrapper {
    ...
    .main{
        background-color: rgba(30, 89, 140, 0.95);
    }
    .header{
        width: 100%;
        height: 21%;
    ...
    .item{
        ...
        height: 5.94vw;
        border-radius: 0.52vw;
        background: #82295E linear-gradient(9.33deg, rgba(154, 154, 154, 0.0001) 7.33%, rgba(154, 154, 154, 0.22) 93.25%);
